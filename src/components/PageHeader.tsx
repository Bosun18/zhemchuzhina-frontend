...
// Контейнер — max-w-6xl, как у хедера сайта в MainLayout: заголовок,
// логотип и левый край контента страниц стоят на одной вертикали.
export default function PageHeader({ title, subtitle, children }: PageHeaderProps) {
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-blue-900 to-blue-800 text-white">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
